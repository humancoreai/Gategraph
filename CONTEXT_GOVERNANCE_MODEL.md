# Context Governance Model — v0.17.5_CANDIDATE
...
This document is carried forward for v0.17.5_CANDIDATE as the current context-governance boundary reference.
...
Base reference: v0.17.5_CANDIDATE.
