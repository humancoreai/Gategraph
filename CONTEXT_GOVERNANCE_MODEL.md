# Context Governance Model — v0.17.5_STABLE
...
This document is carried forward for v0.17.5_STABLE as the current context-governance boundary reference.
