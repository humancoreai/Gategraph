...
CURRENT_RELEASE = "v0.17.5_STABLE"
CURRENT_BASE = "v0.17.4_STABLE"
...
def check_surface_tokens(root: Path | None = None) -> dict[str, Any]:
    ...
    for rel in SURFACE_FILES:
        ...
        if rel in ("RELEASE_METADATA.json", "RELEASE_STATUS.md", "VERSION.md", "docs/RELEASE_v0.17.5_STABLE.md", "registry/promotion_pipeline_registry.json"):
