...
CURRENT_RELEASE = "v0.16.5_STABLE"
...
def check_surface_tokens(root: Path | None = None) -> dict[str, Any]:
    ...
    for rel in SURFACE_FILES:
        ...
        if rel in ("RELEASE_METADATA.json", "RELEASE_STATUS.md", "VERSION.md", "docs/RELEASE_v0.16.5_STABLE.md", "registry/promotion_pipeline_registry.json"):
