...
GateGraph v0.11.5_STABLE is stable-ready for the defined single-node and local/protected server-adapter scope.
...
See also `docs/DEPLOYMENT_BOUNDARY.md` for the supported/unsupported/unsafe deployment surface preserved through v0.11.5_STABLE.
