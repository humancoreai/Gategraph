...
Current release: **v0.14.7_CANDIDATE**  
Base stable: **v0.14.6_STABLE**  
...
```bash
python tools/verify_release.py dist/GateGraph_v0.14.7_CANDIDATE.zip
```
...
Current release base: v0.14.6_STABLE
