...
def main() -> int:
    ...
    metadata["release_focus"] = "Evidence Profile Runtime Profiles"
    ...
    metadata.update({
        ...
        "version": "0.16.6",
        "phase": "Evidence Profile Runtime Profiles",
        "release_focus": "Evidence Profile Runtime Profiles",
