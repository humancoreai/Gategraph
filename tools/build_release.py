...
def build_manifest(files: Iterable[Path]) -> dict:
    ...
    return {
        ...
        "scope": "release_surface_gate_robustness",
...
def main() -> int:
    ...
    metadata.update({
        ...
        "version": "0.16.3",
        "phase": "Release Surface Gate Robustness",
        "release_focus": "Release Surface Gate Robustness",
