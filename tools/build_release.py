...
REQUIRED_RELEASE_FILES = {
    ...
    "docs/RELEASE_v0.16.2_CANDIDATE.md",
...
def build_manifest(files: Iterable[Path]) -> dict:
    ...
    return {
        ...
        "scope": "promotion_pipeline_status_token_hardening",
...
def main() -> int:
    ...
    metadata.update({
        ...
        "version": "0.16.2",
        "phase": "Promotion Pipeline Status Token Hardening",
        "release_focus": "Promotion Pipeline Status Token Hardening",
