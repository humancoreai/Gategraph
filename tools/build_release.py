...
def main() -> int:
    ...
    metadata["release_focus"] = "Surface Version Scanner Formalization"
    ...
    metadata.update({
        ...
        "version": "0.17.4",
        "phase": "Surface Version Scanner Formalization",
        "release_focus": "Surface Version Scanner Formalization",
