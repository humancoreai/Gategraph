...
def main() -> int:
    ...
    metadata["release_focus"] = "Stale Token Revocation / Controlled Apply Safety"
    ...
    metadata.update({
        ...
        "version": "0.15.8",
        "phase": "Stale-token revocation after controlled rule hardening",
        "release_focus": "Stale Token Revocation / Controlled Apply Safety",
