...
REQUIRED_RELEASE_FILES = {
    ...
    "registry/release_status_assertion_policy.json",
    "docs/RELEASE_STATUS_ASSERTION_POLICY.md",
    "tests/release_status_assertion_policy_evidence.py",
    ...
    "tests/cleanup_lifecycle_evidence.py",
    "tests/timeout_normalization_evidence.py",
    "docs/EVIDENCE_LIFECYCLE_CLEANUP.md",
    "docs/TIMEOUT_NORMALIZATION.md",
    ...
    "docs/RELEASE_v0.17.9_CANDIDATE.md",
    ...
    "docs/EVIDENCE_MAINTAINABILITY.md",
    "registry/evidence_maintainability_registry.json",
    "tests/evidence_maintainability_evidence.py",
    "tests/evidence_profile_cleanup_evidence.py",
    "registry/evidence_overlap_matrix.json",
    "docs/EVIDENCE_PROFILE_CLEANUP.md",
    "tests/evidence_runtime_profile_evidence.py",
    "registry/registry_schema_registry.json",
    "src/release_state_normalizer.py",
    "tests/registry_schema_validation_evidence.py",
    "tests/profile_type_validation_evidence.py",
    "tests/release_state_normalization_evidence.py",
...
def main() -> int:
    ...
    metadata = {
        ...
        "artifact_surface_hygiene_scope": True,
        "revocation_negative_path_hardening_scope": True,
    }
    ...
    metadata["release_focus"] = "Evidence Lifecycle Cleanup Formalization"
    ...
    metadata.update({
        ...
        "version": "0.17.9",
        "phase": "Concurrency Scope Evidence Formalization",
        "release_focus": "Concurrency Scope Evidence Formalization",
        ...
        ,"evidence_profile_cleanup_scope": True,
        "evidence_overlap_matrix_scope": True,
        "evidence_deduplication_proposal_only": True,
        "evidence_auto_pruning": False,
        "evidence_tests_removed": False,
        "tests_removed": False,
        "evidence_runtime_profile_scope": True,
        "evidence_profile_execution_scope": True,
        "evidence_profile_runtime_authority": False
    })
