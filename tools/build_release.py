...
def main() -> int:
    ...
    metadata["release_focus"] = "Release Status Token Centralization"
    ...
    metadata.update({
        ...
        "version": "0.16.7",
        "phase": "Release Status Token Centralization",
        "release_focus": "Release Status Token Centralization",
