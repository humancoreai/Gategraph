# OWASP Agentic AI Risk Mapping – v0.17.8_CANDIDATE

This mapping was formally bumped during v0.17.8_CANDIDATE release hygiene. It remains an internal review aid, not a certification claim, and does not assert complete coverage of any external standard.
