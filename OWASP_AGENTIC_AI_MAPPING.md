# OWASP Agentic AI Risk Mapping – v0.11.6_CANDIDATE
...
| Sensitive Observability Leakage | partial | v0.11.6 centralizes token/auth redaction and tests audit/explain/monitoring boundaries. | `tests/capability_token_redaction_evidence.py`, `tests/token_exposure_evidence.py` | Requires ongoing review whenever new export surfaces are added. |
