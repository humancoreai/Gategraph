...
This document defines the release-surface cleanup scope for v0.15.6.

## Purpose

v0.15.6 keeps promotion semantics explicit while avoiding accidental confusion between:
