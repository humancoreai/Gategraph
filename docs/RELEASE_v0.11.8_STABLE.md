...
This stable release builds on `v0.12.0_STABLE` and tightens lifecycle coupling around context governance.
...
Promoted after full Windows Evidence CI reported `Passed: True` for v0.12.0_STABLE on 2026-05-08.
