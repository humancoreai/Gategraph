...
SURFACES = [
    ...
    "docs/RELEASE_v0.14.3_STABLE.md",
]
...
def main() -> int:
    ...
    for surface in SURFACES:
        ...
        if surface in {"README.md", "VERSION.md", "RELEASE_NOTES.md", "RELEASE_STATUS.md", "RELEASE_METADATA.json", "docs/RELEASE_v0.14.3_STABLE.md"} and EXPECTED_BASE not in text:
