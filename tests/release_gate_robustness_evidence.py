...
EXPECTED_RELEASE = "v0.17.9_STABLE"
EXPECTED_BASE = "v0.17.8_STABLE"
EXPECTED_STATUS = "stable" if EXPECTED_RELEASE.endswith("_CANDIDATE") else "stable"
SURFACES = [
    "README.md",
    "VERSION.md",
    "RELEASE_NOTES.md",
...
def main() -> int:
    ...
    for surface in SURFACES:
        ...
        if surface in {"README.md", "VERSION.md", "RELEASE_NOTES.md", "RELEASE_STATUS.md", "RELEASE_METADATA.json", "docs/RELEASE_v0.17.9_STABLE.md"} and EXPECTED_BASE not in text:
