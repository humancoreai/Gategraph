...
EXPECTED_RELEASE = "v0.15.7_CANDIDATE"
EXPECTED_BASE = "v0.15.6_STABLE"
EXPECTED_STATUS = "candidate"
EXPECTED_PHASE = "Production-readiness audit and operator-transparency consolidation"
SURFACES = [
    "README.md",
    "VERSION.md",
    "RELEASE_NOTES.md",
    "RELEASE_STATUS.md",
    "CHANGELOG.md",
    "docs/RELEASE_v0.15.7_CANDIDATE.md",
]
...
def main() -> int:
    ...
    checks.append(check("release_doc_manifested", "docs/RELEASE_v0.15.7_CANDIDATE.md" in manifest_paths, {"present": "docs/RELEASE_v0.15.7_CANDIDATE.md" in manifest_paths}))
