...
EXPECTED_RELEASE = "v0.13.2_CANDIDATE"
EXPECTED_BASE = "v0.13.1_STABLE"
EXPECTED_STATUS = "candidate"
EXPECTED_PHASE = "Candidate CI Gate Hardening"
SURFACES = [
    "README.md",
    "VERSION.md",
    "RELEASE_NOTES.md",
    "RELEASE_STATUS.md",
    "CHANGELOG.md",
    "docs/RELEASE_v0.13.2_CANDIDATE.md",
]
...
def main() -> int:
    ...
    checks.append(check("release_doc_manifested", "docs/RELEASE_v0.13.2_CANDIDATE.md" in manifest_paths, {"present": "docs/RELEASE_v0.13.2_CANDIDATE.md" in manifest_paths}))
