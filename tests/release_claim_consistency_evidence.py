...
EXPECTED_PHASE = "Stable-aware promotion and release-surface hardening"
SURFACES = [
    "README.md",
    "VERSION.md",
    "RELEASE_NOTES.md",
...
def main() -> int:
    ...
    checks.append(check("release_doc_manifested", "docs/RELEASE_v0.15.1_CANDIDATE.md" in manifest_paths, {"present": "docs/RELEASE_v0.15.1_CANDIDATE.md" in manifest_paths}))
