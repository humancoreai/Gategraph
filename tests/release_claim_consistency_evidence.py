...
SURFACES = [
    ...
    "RELEASE_STATUS.md",
    "CHANGELOG.md",
    "docs/RELEASE_v0.13.2_STABLE.md",
]
...
def main() -> int:
    ...
    checks.append(check("release_doc_manifested", "docs/RELEASE_v0.13.2_STABLE.md" in manifest_paths, {"present": "docs/RELEASE_v0.13.2_STABLE.md" in manifest_paths}))
