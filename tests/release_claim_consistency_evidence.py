...
EXPECTED_PHASE = "GitHub Actions CI Preparation"
SURFACES = [
    "README.md",
    "VERSION.md",
    "RELEASE_NOTES.md",
...
def main() -> int:
    ...
    checks.append(check("release_doc_manifested", "docs/RELEASE_v0.13.6_CANDIDATE.md" in manifest_paths, {"present": "docs/RELEASE_v0.13.6_CANDIDATE.md" in manifest_paths}))
