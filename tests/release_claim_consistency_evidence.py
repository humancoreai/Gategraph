...
EXPECTED_RELEASE = "v0.14.7_CANDIDATE"
EXPECTED_BASE = "v0.14.6_STABLE"
...
SURFACES = [
    ...
    "RELEASE_STATUS.md",
    "CHANGELOG.md",
    "docs/RELEASE_v0.14.7_CANDIDATE.md",
]
...
def main() -> int:
    ...
    checks.append(check("release_doc_manifested", "docs/RELEASE_v0.14.7_CANDIDATE.md" in manifest_paths, {"present": "docs/RELEASE_v0.14.7_CANDIDATE.md" in manifest_paths}))
