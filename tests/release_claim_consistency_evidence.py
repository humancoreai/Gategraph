...
EXPECTED_PHASE = "Evidence Suite Profile Management"
SURFACES = [
    "README.md",
    "VERSION.md",
    "RELEASE_NOTES.md",
...
def main() -> int:
    ...
    checks.append(check("release_doc_manifested", "docs/RELEASE_v0.13.3_CANDIDATE.md" in manifest_paths, {"present": "docs/RELEASE_v0.13.3_CANDIDATE.md" in manifest_paths}))
