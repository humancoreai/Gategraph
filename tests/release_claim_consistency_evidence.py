...
def main() -> int:
    ...
    checks.append(check("release_doc_manifested", "docs/RELEASE_v0.16.0_CANDIDATE.md" in manifest_paths, {"present": "docs/RELEASE_v0.16.0_CANDIDATE.md" in manifest_paths}))
