...
EXPECTED_PHASE = "Stable-promotion evidence regression hardening and release-surface consistency cleanup"
SURFACES = [
    "README.md",
    "VERSION.md",
    "RELEASE_NOTES.md",
...
def main() -> int:
    ...
    checks.append(check("release_doc_manifested", "docs/RELEASE_v0.15.5_CANDIDATE.md" in manifest_paths, {"present": "docs/RELEASE_v0.15.5_CANDIDATE.md" in manifest_paths}))
