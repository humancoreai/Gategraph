...
EXPECTED_PHASE = "Release truth centralization and evidence-maintainability cleanup"
SURFACES = [
    "README.md",
    "VERSION.md",
    "RELEASE_NOTES.md",
    "RELEASE_STATUS.md",
    "CHANGELOG.md",
    "docs/RELEASE_v0.15.4_STABLE.md",
]
...
def main() -> int:
    ...
    checks.append(check("release_doc_manifested", "docs/RELEASE_v0.15.4_STABLE.md" in manifest_paths, {"present": "docs/RELEASE_v0.15.4_STABLE.md" in manifest_paths}))
