...
EXPECTED_RELEASE = "v0.14.10_STABLE"
...
def main() -> int:
    ...
    checks.append(check("release_doc_manifested", "docs/RELEASE_v0.14.10_STABLE.md" in manifest_paths, {"present": "docs/RELEASE_v0.14.10_STABLE.md" in manifest_paths}))
