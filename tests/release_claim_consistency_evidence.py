...
EXPECTED_PHASE = "Evidence Failure Classification"
SURFACES = [
    "README.md",
    "VERSION.md",
    "RELEASE_NOTES.md",
    "RELEASE_STATUS.md",
    "CHANGELOG.md",
    "docs/RELEASE_v0.13.4_CANDIDATE.md",
]
...
def main() -> int:
    ...
    checks.append(check("release_doc_manifested", "docs/RELEASE_v0.13.4_CANDIDATE.md" in manifest_paths, {"present": "docs/RELEASE_v0.13.4_CANDIDATE.md" in manifest_paths}))
