...
EXPECTED_PHASE = "Promotion semantics cleanup and stable-surface separation"
SURFACES = [
    "README.md",
    "VERSION.md",
    "RELEASE_NOTES.md",
...
def main() -> int:
    ...
    checks.append(check("release_doc_manifested", "docs/RELEASE_v0.15.2_CANDIDATE.md" in manifest_paths, {"present": "docs/RELEASE_v0.15.2_CANDIDATE.md" in manifest_paths}))
