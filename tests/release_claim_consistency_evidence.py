...
EXPECTED_RELEASE = "v0.13.5_CANDIDATE"
EXPECTED_BASE = "v0.13.4_STABLE"
EXPECTED_STATUS = "candidate"
EXPECTED_PHASE = "Release Gate Robustness"
SURFACES = [
    "README.md",
    "VERSION.md",
    "RELEASE_NOTES.md",
    "RELEASE_STATUS.md",
    "CHANGELOG.md",
    "docs/RELEASE_v0.13.5_CANDIDATE.md",
]
...
def main() -> int:
    ...
    checks.append(check("release_doc_manifested", "docs/RELEASE_v0.13.5_CANDIDATE.md" in manifest_paths, {"present": "docs/RELEASE_v0.13.5_CANDIDATE.md" in manifest_paths}))
