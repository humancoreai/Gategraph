...
def main() -> int:
    ...
    checks.append(check("release_doc_manifested", "docs/RELEASE_v0.15.4_CANDIDATE.md" in manifest_paths, {"present": "docs/RELEASE_v0.15.4_CANDIDATE.md" in manifest_paths}))
