...
EXPECTED_PHASE = "Practical Single-Node Scenario Run"
SURFACES = [
    "README.md",
    "VERSION.md",
    "RELEASE_NOTES.md",
...
def main() -> int:
    ...
    checks.append(check("release_doc_manifested", "docs/RELEASE_v0.14.0_CANDIDATE.md" in manifest_paths, {"present": "docs/RELEASE_v0.14.0_CANDIDATE.md" in manifest_paths}))
