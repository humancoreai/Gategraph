...
EXPECTED_RELEASE = "v0.14.8_CANDIDATE"
EXPECTED_BASE = "v0.14.7_STABLE"
EXPECTED_STATUS = "candidate"
EXPECTED_PHASE = "Release artifact determinism and failure explainability"
SURFACES = [
    "README.md",
    "VERSION.md",
    "RELEASE_NOTES.md",
    "RELEASE_STATUS.md",
    "CHANGELOG.md",
    "docs/RELEASE_v0.14.8_CANDIDATE.md",
]
...
def main() -> int:
    ...
    checks.append(check("release_doc_manifested", "docs/RELEASE_v0.14.8_CANDIDATE.md" in manifest_paths, {"present": "docs/RELEASE_v0.14.8_CANDIDATE.md" in manifest_paths}))
