...
def main() -> int:
    ...
    checks = []
    checks.append(check("lineage_release_stable", data.get("release") == "v0.12.7_CANDIDATE", {"release": data.get("release")}))
    checks.append(check("lineage_base_stable", data.get("base") == "v0.12.6_STABLE", {"base": data.get("base")}))
    ...
    expected_tail = ["v0.12.3_STABLE", "v0.12.4_STABLE", "v0.12.5_STABLE", "v0.12.6_STABLE", "v0.12.7_CANDIDATE"]
