...
def main() -> int:
    ...
    check("metadata_current_release", metadata.get("release") == "v0.17.7_STABLE" and metadata.get("status") == "stable", {"release": metadata.get("release"), "status": metadata.get("status")})
