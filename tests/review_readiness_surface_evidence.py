...
REQUIRED_SURFACES = [
    ...
    "docs/SCOPE_BACKLOG.md", "docs/RELEASE_v0.16.5_STABLE.md", "SECURITY.md", "PRODUCTION.md", "TRUST_MODEL.md",
]
...
def main():
    ...
    for path in ["README.md", "VERSION.md", "RELEASE_STATUS.md", "docs/RELEASE_v0.16.5_STABLE.md"]:
