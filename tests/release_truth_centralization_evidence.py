...
def main() -> int:
    ...
    checks = []
    checks.append(check("metadata_current_release", truth.release == "v0.16.6_STABLE" and truth.base == "v0.16.5_STABLE" and truth.status == "stable", {"release": truth.release, "base": truth.base, "status": truth.status}))
