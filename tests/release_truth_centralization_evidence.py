...
def main() -> int:
    ...
    checks = []
    checks.append(check("metadata_current_candidate", truth.release == "v0.15.5_CANDIDATE" and truth.base == "v0.15.4_STABLE" and truth.status == "candidate", {"release": truth.release, "base": truth.base, "status": truth.status}))
    ...
    checks.append(check("future_stable_is_derived_not_current", truth.future_stable == "v0.15.5_STABLE" and truth.future_stable != truth.release, {"future_stable": truth.future_stable}))
