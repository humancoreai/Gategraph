...
def main() -> int:
    ...
    checks = []
    checks.append(check("metadata_current_candidate", truth.release == "v0.16.5_STABLE" and truth.base == "v0.16.4_STABLE" and truth.status == "stable", {"release": truth.release, "base": truth.base, "status": truth.status}))
