...
def main() -> int:
    ...
    checks = []
    checks.append(check("metadata_current_stable", truth.release == "v0.15.4_STABLE" and truth.base == "v0.15.4_STABLE" and truth.status == "stable", {"release": truth.release, "base": truth.base, "status": truth.status}))
    ...
    checks.append(check("stable_token_matches_current_release", truth.future_stable == "v0.15.4_STABLE" and truth.future_stable == truth.release, {"future_stable": truth.future_stable}))
