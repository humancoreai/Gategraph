...
def main() -> int:
    ...
    checks = []
    checks.append(check("metadata_current_candidate", truth.release == "v0.16.1_CANDIDATE" and truth.base == "v0.16.0_STABLE" and truth.status == "candidate", {"release": truth.release, "base": truth.base, "status": truth.status}))
    ...
    checks.append(check(
        ...
        truth.future_stable == "v0.16.1_STABLE"
