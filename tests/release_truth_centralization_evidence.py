...
def main() -> int:
    ...
    checks = []
    checks.append(check("metadata_current_stable", truth.release == "v0.15.9_CANDIDATE" and truth.base == "v0.15.8_STABLE" and truth.status == "candidate", {"release": truth.release, "base": truth.base, "status": truth.status}))
    ...
    checks.append(check(
        ...
        truth.future_stable == "v0.15.9_STABLE"
