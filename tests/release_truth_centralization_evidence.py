...
def main() -> int:
    ...
    checks = []
    checks.append(check("metadata_current_stable", truth.release == "v0.16.3_CANDIDATE" and truth.base == "v0.16.2_STABLE" and truth.status == "candidate", {"release": truth.release, "base": truth.base, "status": truth.status}))
