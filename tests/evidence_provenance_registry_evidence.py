...
def main() -> int:
    ...
    checks = []
    checks.append(check("provenance_release_stable", data.get("release") == "v0.17.3_CANDIDATE", {"release": data.get("release")}))
    checks.append(check("provenance_base_stable", data.get("base") == "v0.17.2_STABLE", {"base": data.get("base")}))
