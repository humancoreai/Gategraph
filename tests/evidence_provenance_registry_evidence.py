...
def main() -> int:
    ...
    checks = []
    checks.append(check("provenance_release_stable", data.get("release") == "v0.16.2_CANDIDATE", {"release": data.get("release")}))
    checks.append(check("provenance_base_stable", data.get("base") == "v0.16.1_STABLE", {"base": data.get("base")}))
