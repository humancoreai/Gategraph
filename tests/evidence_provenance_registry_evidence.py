...
def main() -> int:
    ...
    checks = []
    checks.append(check("provenance_release_stable", data.get("release") == "v0.15.4_CANDIDATE", {"release": data.get("release")}))
    checks.append(check("provenance_base_stable", data.get("base") == "v0.15.4_STABLE", {"base": data.get("base")}))
