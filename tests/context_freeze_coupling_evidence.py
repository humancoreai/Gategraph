...
EXPECTED_RELEASE='v0.15.4_STABLE'; EXPECTED_BASE='v0.15.4_STABLE'
REQUIRED_FILES={'gategraph/context/context_lifecycle.py','docs/CONTEXT_LIFECYCLE_MODEL.md','tests/context_lifecycle_evidence.py','tests/context_freeze_coupling_evidence.py','tests/context_replay_explain_boundary_evidence.py','docs/RELEASE_v0.15.4_STABLE.md'}
