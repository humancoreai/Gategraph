...
REQUIRED_COVERAGE = {
    ...
    "docs/RELEASE_v0.12.9_CANDIDATE.md",
...
def main() -> int:
    ...
    checks.append(check("manifest_release_matches_stable", manifest.get("release") == "v0.12.9_CANDIDATE", {"release": manifest.get("release")}))
