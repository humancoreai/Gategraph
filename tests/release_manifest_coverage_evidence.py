...
REQUIRED_COVERAGE = {
    ...
    "docs/RELEASE_v0.12.8_CANDIDATE.md",
...
def main() -> int:
    ...
    checks.append(check("manifest_release_matches_candidate", manifest.get("release") == "v0.12.8_CANDIDATE", {"release": manifest.get("release")}))
