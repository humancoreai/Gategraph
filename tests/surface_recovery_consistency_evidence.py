...
def main() -> int:
    ...
    required={'src/recovery_foundation.py','tests/recovery_foundation_evidence.py','tests/replay_recovery_consistency_evidence.py','tests/surface_recovery_consistency_evidence.py','docs/RECOVERY_FOUNDATION.md','docs/RELEASE_v0.12.2_STABLE.md'}
    ...
    assert EXPECTED_RELEASE in read('RELEASE_NOTES.md') and 'Recovery' in read('RELEASE_NOTES.md') and 'Replay' in read('RELEASE_NOTES.md')
