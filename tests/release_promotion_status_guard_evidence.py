...
def main() -> int:
    ...
    checks.append(("metadata_current_release", release == "v0.17.5_STABLE" and base == "v0.17.4_STABLE" and status == expected_status, {"release": release, "base": base, "status": status}))
