...
def main() -> int:
    ...
    checks.append(("metadata_current_release", release == "v0.17.9_STABLE" and base == "v0.17.8_STABLE" and status == expected_status, {"release": release, "base": base, "status": status}))
