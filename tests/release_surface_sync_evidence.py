...
EXPECTED_VERSION='0.12.7'
SURFACES=['README.md','VERSION.md','RELEASE_NOTES.md','RELEASE_STATUS.md','RELEASE_METADATA.json','RELEASE_MANIFEST.json','pyproject.toml','tools/build_release.py','tools/verify_release.py','docs/RECOVERY_FOUNDATION.md','docs/RELEASE_v0.12.7_CANDIDATE.md']
...
def main() -> int:
    ...
    assert meta['phase']=='Release State Transition / Promotion Surface Symmetry'
