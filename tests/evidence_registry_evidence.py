...
def main() -> None:
    ...
    check("registry_release_current", data.get("release") == "v0.15.7_CANDIDATE", {"release": data.get("release")})
    check("registry_base_previous_stable", data.get("base") == "v0.15.6_STABLE", {"base": data.get("base")})
