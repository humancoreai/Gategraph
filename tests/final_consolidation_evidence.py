...
def main() -> None:
    ...
    assert "v0.15.1_CANDIDATE" in version
    assert "v0.15.0_STABLE" in version
    assert "Stable-aware promotion and release-surface hardening" in status
...
# Current release surface: v0.15.1_CANDIDATE
