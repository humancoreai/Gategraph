...
def main() -> None:
    ...
    assert "v0.15.2_CANDIDATE" in version
    assert "v0.15.1_STABLE" in version
    assert "Promotion semantics cleanup and stable-surface separation" in status
...
# Current release surface: v0.15.2_CANDIDATE
