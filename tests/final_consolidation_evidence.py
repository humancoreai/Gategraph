...
def main() -> None:
    ...
    assert "v0.15.3_CANDIDATE" in version
    assert "v0.15.2_STABLE" in version
    assert "Release truth centralization and evidence-maintainability cleanup" in status
...
# Current release surface: v0.15.3_CANDIDATE
