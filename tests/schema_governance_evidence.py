...
def main() -> int:
    ...
    checks.append(check("registry_release_stable", data.get("release") == "v0.15.9_CANDIDATE", {"release": data.get("release")}))
    checks.append(check("registry_base_stable", data.get("base") == "v0.15.8_STABLE", {"base": data.get("base")}))
