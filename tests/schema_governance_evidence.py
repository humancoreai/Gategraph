...
def main() -> int:
    ...
    checks.append(check("registry_release_stable", data.get("release") == "v0.17.8_CANDIDATE", {"release": data.get("release")}))
    checks.append(check("registry_base_stable", data.get("base") == "v0.17.7_STABLE", {"base": data.get("base")}))
