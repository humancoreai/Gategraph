...
def main() -> int:
    ...
    checks.append(check("registry_release_stable", data.get("release") == "v0.13.6_CANDIDATE", {"release": data.get("release")}))
    checks.append(check("registry_base_stable", data.get("base") == "v0.13.5_STABLE", {"base": data.get("base")}))
