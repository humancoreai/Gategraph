...
def main() -> None:
    ...
    assert "Evidence artifact hygiene and revocation negative-path hardening" in status, "RELEASE_STATUS.md missing phase label"
...
# Current release surface: v0.16.3_CANDIDATE
