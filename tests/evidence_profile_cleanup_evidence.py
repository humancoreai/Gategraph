...
def main() -> int:
    ...
    checks.append(check("metadata_current_release", metadata.get("release") == "v0.16.6_STABLE" and metadata.get("base") == "v0.16.5_STABLE" and metadata.get("status") == "stable", {"release": metadata.get("release"), "base": metadata.get("base"), "status": metadata.get("status")}))
