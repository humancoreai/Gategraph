...
def main() -> int:
    ...
    check("metadata_current_release", meta.get("release") == "v0.17.9_CANDIDATE" and meta.get("base") == "v0.17.8_STABLE" and meta.get("status") in {"candidate", "stable"}, {"release": meta.get("release"), "base": meta.get("base"), "status": meta.get("status")}, results)
