...
def main() -> int:
    ...
    check("metadata_current_release", meta.get("release") == "v0.17.0_CANDIDATE" and meta.get("base") == "v0.16.9_STABLE" and meta.get("status") == "candidate", {"release": meta.get("release"), "base": meta.get("base"), "status": meta.get("status")}, results)
