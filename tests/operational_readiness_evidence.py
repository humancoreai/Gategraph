...
def main() -> int:
    ...
    check("metadata_current_release", meta.get("release") == "v0.17.0_STABLE" and meta.get("base") == "v0.16.9_STABLE" and meta.get("status") == "stable", {"release": meta.get("release"), "base": meta.get("base"), "status": meta.get("status")}, results)
