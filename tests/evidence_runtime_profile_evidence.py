...
def main() -> int:
    ...
    check("metadata_current_release", metadata.get("release") == "v0.16.7_CANDIDATE" and metadata.get("status") == "candidate", {"release": metadata.get("release"), "status": metadata.get("status")}, failures)
