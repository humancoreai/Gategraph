<!-- v0.17.2_CANDIDATE note: External review surface refreshed for repository hygiene; no governance logic expansion. -->
...
The reviewable claim for v0.17.2_CANDIDATE is narrow:
...
This surface was refreshed in v0.17.2_CANDIDATE to remove stale review-baseline version claims.
...
Base reference: v0.17.2_CANDIDATE.
