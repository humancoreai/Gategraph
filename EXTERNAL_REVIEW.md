<!-- v0.16.7_STABLE note: External review surface refreshed for repository hygiene; no governance logic expansion. -->
...
The reviewable claim for v0.16.7_STABLE is narrow:
...
This surface was refreshed in v0.16.7_STABLE to remove stale review-baseline version claims.
