<!-- v0.16.3_STABLE note: External review surface refreshed for repository hygiene; no governance logic expansion. -->
...
The reviewable claim for v0.16.3_STABLE is narrow:
...
This surface was refreshed in v0.16.3_STABLE to remove stale review-baseline version claims.
